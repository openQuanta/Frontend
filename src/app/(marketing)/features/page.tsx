            ...
            >
              <div className="w-[840px] h-full overflow-y-auto p-10">
                ...
                <p className="text-[20px] text-zinc-400 leading-relaxed w-full">
                  ...
                  adipisicing elit. Provident aut obcaecati harum veritatis
                  velit, iste ipsam eos, repellendus a adipisci beatae saepe
                  repellat deleniti. Voluptatem placeat suscipit odio aperiam
                  voluptates, exercitationem, optio modi earum repellendus
                  praesentium nesciunt voluptatum ea consectetur, ex corporis
                  quasi nemo. Ex incidunt sequi autem quas voluptatem! Ut,
                  deleniti. Exercitationem facere corrupti sed quas magnam nulla
                  possimus dolor commodi.
                </p>
              </div>
            </section>
          ))}
        ...
        <div>
          <h2 className="w-[450px] h-[80px] text-[30px] leading-10 ">
            ...
            <span className="text-[#FF5a1f]">
              security measures to ensurentinuity
            </span>
          </h2>
          <p className="w-[601px] h-[96px] text-[16px] opacity-40 mt-[17px] leading-6">
            ...
            assessing IT security is particularly challenging.urity requires
            specialized knowledge and expertise that hese investments offer
      ...
      <div className="flex flex-col justify-center items-center text-center gap-[80px] mb-20 px-4">
        <div>
          ...
          <p className="text-[16px] opacity-64">
            All you need is research. We'll handle the rest from on-chain proof
            to peer discovery
          </p>
        </div>
