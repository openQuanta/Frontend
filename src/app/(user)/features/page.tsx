...
import { Caret } from "@/assets/images";
...
export default function Page() {
    ...
    return (
        <div className="flex flex-col gap-[40px]">
            <div className="flex flex-col gap-[64px] px-[87px] pt-[200px] ">
                <div className="flex flex-col">
                    <div className="grid gap-10 mb-[64px]">
                        ...
                        <h2 className="text-[74px] w-[984px] h-[168px] leading-[84px]">Powering the future of research publishing</h2>
                    </div>
                    <p className="text-[16px] opacity-64 w-[984px] h-[77px]">
                        Submit <span className="bg-[#6D78D5] border-[#6D78D5]">Papers </span> <sup className="bg-[#6D78D5] w-[28.64px] h-[16.78px] mb-[30px]">Joe</sup>and build your <span className="">reputation</span> in a new era of publishers collaboration. We make research verifiable, and <br /> market-driven through blockchain technology.
            ...
            <div className="w-[1442px] h-[713px] gap-[120px] flex flex-row ml-[47px] border ">
                {/* Scroll navigation */} 
                <div className="w-[271px] h-[416px] flex gap-[20px]">
                    <div className="min-h-screen bg-black w-11 relative">
                        <ScrollIndicator sections={sections} className="absolute left-8 top-1/2 -translate-y-1/2"/>

                    </div>
                </div>
        
                <div className="w-[861px] h-[520px] mt-30 ">
                    <div className="flex"> 
            ...
            <div>
                <div className="ml-80 pr-20">
                    {sections.map((section) => (
                        <section key={section.id} id={section.id} className="min-h-screen flex items-center justify-center">
                            <div className="max-w-4xl">
                                <h2 className="text-6xl font-light text-white mb-6">{section.label}</h2>
                                <p className="text-xl text-zinc-400 leading-relaxed">
                                    This is the content section for {section.label}. Add your actual content here. Lorem ipsum dolor sit
